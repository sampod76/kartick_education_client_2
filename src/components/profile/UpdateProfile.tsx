...
import { useGetProfileQuery, useUserLoginMutation } from '@/redux/api/auth/authApi';
import {
...
const UpdateProfile = () => {
  ...
  const [updateAdmin, { isLoading: updateAdminLoader }] = useUpdateAdminMutation();
        ...
        <Form submitHandler={onSubmit} defaultValues={defaultValues}>
          ...
          >
            ...
            <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
              ...
              >
                <FormInput type="text" name="name" size="large" label="Full Name" />
              </Col>
              <Col
                className="gutter-row"
                xs={24}
