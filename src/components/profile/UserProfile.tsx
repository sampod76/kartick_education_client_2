    ...
    <main className="profile-page">
      <div className="max-w-2xl mx-4 sm:max-w-sm md:max-w-sm lg:max-w-[30rem] xl:max-w-[30rem] sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto mt-2 bg-white shadow-xl rounded-lg text-gray-900">
        ...
        <div className="px-3 mt-1">
          ...
          <div className="text-[10px] my-3 text-gray-800">
            ...
            <h2>
              {' '}
              <BankOutlined />
              <span className="text-[14px] ml-2 "> BirthDay: {dateOfBirth}</span>
            </h2>
            <h2>
              <EnvironmentOutlined /> <span className="text-[14px] ml-2 ">{address}</span>
            </h2>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-around my-4 py-5">
          ...
          <Link
            href="/"
            className="p-2 mr-2 text-red-600 rounded-full shadow-md dark:hover:text-red-400 hover:text-red-700 dark:text-gray-400"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
