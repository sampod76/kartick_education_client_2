...
const LessonSerialUpdate = ({
  queryObject,
}: {
  queryObject?: { course?: string; category?: string; module: string };
}) => {
  ...
  const [sortBy, setSortBy] = useState<string>('lesson_number');
  ...
  query['module'] = queryObject?.module;
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center px-3">
        <div></div>
        <h1 className="text-center m-2 ">Lesson Position Update</h1>
        <Button
          loading={Sloading}
...
export default LessonSerialUpdate;
