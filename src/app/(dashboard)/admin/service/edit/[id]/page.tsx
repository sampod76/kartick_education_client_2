...
const EditServicePage = ({ params }: any) => {
  ...
  const [updateService, { isLoading: updateLoading, error }] = useUpdateServiceMutation();
        ...
        <Form submitHandler={onSubmit} defaultValues={defaultValues}>
          ...
          >
            ...
            <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
              ...
              >
                <FormInput type="text" name="title" size="large" label="Service Name" />
              </Col>
              <div>
                <Col
                  className="gutter-row"
              ...
              <Col span={12} style={{ margin: '10px 0' }}>
                <FormTextArea name="description" label="Service description" rows={4} />
              </Col>
